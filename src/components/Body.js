    ...
    <section className="text-center mb-10 overflow-hidden">
      ...
      <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <img 
          ...
          alt="image1" 
          className="max-w-[574px] w-4/5 mx-auto animate-pulse" 
        />
      ...
      <div className="w-full md:px-16 md:py-10 px-6 py-6 my-24 bg-[#EA5537] border-b-[10px] border-white text-center flex-col gap-20 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
        ...
        <div className="bg-black/20 rounded-lg p-4 backdrop-blur-sm">
          <p className="text-white lg:text-[37px] md:text-2xl text-lg mt-4 text-left break-words select-all hover:bg-black/30 transition-colors duration-200 p-2 rounded" 
      ...
      >
        ...
        <div className='flex md:flex-row flex-col max-w-[1500px] justify-between w-full items-center mx-auto relative z-10'>
          <div className="transform hover:scale-105 transition-transform duration-500">
            <img src="/images/image_2.png" alt="image2" className="md:w-[40%] w-5/6 object-contain drop-shadow-2xl" />
          </div>
